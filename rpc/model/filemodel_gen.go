...
func (m *defaultFileModel) Insert(ctx context.Context, data *File) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Id, data.Name, data.Type, data.Size, data.Path, data.StorageProvider, data.OwnerId, data.Status, data.Tags, data.Checksum)
	}, fileIdKey)
	return ret, err
}
...
func (m *defaultFileModel) Update(ctx context.Context, data *File) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Name, data.Type, data.Size, data.Path, data.StorageProvider, data.OwnerId, data.Status, data.Tags, data.Checksum, data.Id)
	}, fileIdKey)
	return err
}
